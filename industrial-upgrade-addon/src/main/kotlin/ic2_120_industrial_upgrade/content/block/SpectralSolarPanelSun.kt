    ...
    companion object {
        ...
        fun generateRecipes(exporter: Consumer<RecipeJsonProvider>) {
            ...
            ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, SpectralSolarPanelBlock::class.item(), 1)
                .input(SpectralSolarPanelSunBlock::class.item())
                .criterion(hasItem(SpectralSolarPanelSunBlock::class.item()), conditionsFromItem(SpectralSolarPanelSunBlock::class.item()))
                .offerTo(exporter, IC2IndustrialUpgrade.id("spectral_solar_panelsun_revert"))
        }
    }
}
