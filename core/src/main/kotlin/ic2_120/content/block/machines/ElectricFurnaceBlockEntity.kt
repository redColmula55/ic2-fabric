...
class ElectricFurnaceBlockEntity(
    ...
    override fun createMenu(syncId: Int, playerInventory: PlayerInventory, player: PlayerEntity?): ScreenHandler =
        ElectricFurnaceScreenHandler(syncId, playerInventory, this, net.minecraft.screen.ScreenHandlerContext.create(world!!, pos), syncedData, itemStorage)
    ...
    fun tick(world: World, pos: BlockPos, state: BlockState) {
        ...
        energyDebtF = EnergyDebtAccounting.accrue(energyDebtF, ElectricFurnaceSync.ENERGY_PER_TICK * energyMultiplier, sync.getEffectiveCapacity())
