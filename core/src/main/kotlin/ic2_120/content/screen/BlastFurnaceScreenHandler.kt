...
@ModScreenHandler(block = BlastFurnaceBlock::class, inventorySize = BlastFurnaceBlockEntity.INVENTORY_SIZE)
class BlastFurnaceScreenHandler(
    ...
    init {
        ...
        addTrackedSlot(blockInventory, BlastFurnaceBlockEntity.SLOT_INPUT, x = 35, y = 33)
        addTrackedSlot(blockInventory, BlastFurnaceBlockEntity.SLOT_AIR_INPUT, x = 9, y = 63)
        addTrackedSlot(blockInventory, BlastFurnaceBlockEntity.SLOT_OUTPUT_STEEL, x = 134, y = 56)
        addTrackedSlot(blockInventory, BlastFurnaceBlockEntity.SLOT_OUTPUT_SLAG, x = 152, y = 56)
        addTrackedSlot(blockInventory, BlastFurnaceBlockEntity.SLOT_OUTPUT_EMPTY, x = 27, y = 63)

        for (i in BlastFurnaceBlockEntity.SLOT_UPGRADE_INDICES.indices) {
            addTrackedSlot(blockInventory, BlastFurnaceBlockEntity.SLOT_UPGRADE_INDICES[i], x = 152, y = 8 + i * 18)
        }
